...
Assim como a média da avaliação de beleza, as variáveis $idade$, $tipoDaFoto$ e $corDaFoto$ não explicam significativamente a variância da avaliação dos professores. O modelo de regressão linear multivariada, gerado com estas 3 últimas variáveis, no formato $avaliacao = 4.72 - 0.006*idade - 0.06*tipoDaFoto - 0.22*corDaFoto$ explica apenas 3,73% da variância da variável de resposta (R2 = 0.0372), 0,2% a mais que o modelo anterior. $idade$, medida como a idade de cada professor, com valores entre [29, 73], tem uma relação não significativa com o erro b = [-0,01; -0,001], IC com 95%; $tipoDaFoto$, medida como a roupa do professor na foto avaliada, com os valores formal (0) e informal (1), tem uma relação não significativa com o erro b = [-0,19; 0,08], IC com 95% e, por fim, $corDaFoto$, medida como a cor da foto avaliada do professor, com os valores colorida (1) e preta&branco (0), tem uma relação não significativa com o erro b = [-0,35; -0,09], IC com 95%. O aumento de 1 unidade de $idade$ produz uma mudança de -0.006 na avaliação dos professores ($score$), enquanto $tipoDaFoto$ e $corDaFoto$ alteram -0.06 e -0.22, respectivamente.
